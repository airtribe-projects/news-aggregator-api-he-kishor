...
const Prefrence_f = require('../../News/models/preferenceModels');
...
const registerUser = async({fname, lname, email, pass, role, gender})=> {
    ...
    const preferenc = await Prefrence_f.create({  category: "",  // Default value, can be omitted since it's already set in the schema
        language: "en", 
        sortby: "", 
        country:"",
        from_date: null, 
        to_date: null, 
        u_id: userResponse._id
    });
